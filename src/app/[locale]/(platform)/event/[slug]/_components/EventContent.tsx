...
import PainelApostas from '@/app/[locale]/(platform)/event/[slug]/_components/PainelApostas'
  ...
  return (
    <EventMarketChannelProvider markets={event.markets}>
      <EventOutcomeChanceProvider eventId={event.id}>
        ...
        <div className={cn("container mx-auto grid gap-8 pt-2 pb-20 md:pt-5 md:pb-0 items-start", !event.slug.startsWith('live-') && "lg:grid-cols-[1fr_21.25rem]")}>
