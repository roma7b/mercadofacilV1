...
import { BadgePercentIcon, CalendarIcon, LanguagesIcon, SettingsIcon, SparklesIcon, SwatchBookIcon, TagsIcon, TextSelectIcon, UsersIcon, WalletIcon } from 'lucide-react'
...
export default function AdminSidebar() {
  ...
  const adminMenuItems: AdminMenuItem[] = [
    ...
    { id: 'mercado-hype', label: 'Hype Factory', href: '/admin/mercado-hype' as Route, icon: SparklesIcon },
    { id: 'finance', label: 'Financeiro', href: '/admin/finance' as Route, icon: WalletIcon },
