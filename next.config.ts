...
const config: NextConfig = {
  ...
  env: {
    ...
    WS_CLOB_URL: (process.env.WS_CLOB_URL ?? 'wss://ws-subscriptions-clob.kuest.com').replace(/^ws:\/\//, 'wss://'),
    WS_LIVE_DATA_URL: (process.env.WS_LIVE_DATA_URL ?? 'wss://ws-live-data.kuest.com').replace(/^ws:\/\//, 'wss://'),
  },
}
